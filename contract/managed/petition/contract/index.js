...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      sign: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`sign: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('sign',
                                     'argument 1 (as invoked from Typescript)',
                                     'petition.compact line 13 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._sign_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = { sign: this.circuits.sign };
    this.provableCircuits = { sign: this.circuits.sign };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
  ...
  _getUserSecret_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('getUserSecret',
                                 'return value',
                                 'petition.compact line 8 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _sign_0(context, partialProofData) {
    const secret_0 = this._getUserSecret_0(context, partialProofData);
    const nullifier_0 = this._persistentCommit_0(secret_0, secret_0);
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'petition.compact line 6 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
